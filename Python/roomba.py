...
roomba = Roomba('Roomba Skywalker')
for i in range(1):
	...
	pylab.plot(coords[0],coords[1],marker='^',linestyle=':',color='blue')

pylab.title('Random Roomba Walk')
pylab.xlabel('Vertical Locations')
pylab.ylabel('Horizontal Locations')
pylab.show()
